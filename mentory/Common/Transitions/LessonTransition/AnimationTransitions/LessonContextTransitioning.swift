//
//  LessonContextTransitioning.swift. Действующие при анимации объекты
//
...
public struct LessonContextTransitioning {
    // MARK: - Properties
    ...
    let biggerView: ViewLessonAnimatable?
    ...
    let smallestView: ViewLessonAnimatable?
    ...
    internal init(
        ...
        originStartView: ViewLessonAnimatable?,
        originEndView: ViewLessonAnimatable?
    ) {
